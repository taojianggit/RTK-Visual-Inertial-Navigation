...
std::string RESULT_PATH_TOTAL = "result_total.csv";
std::string RESULT_PATH_GNSS = "result_gnss.csv";
std::string RESULT_PATH_IMU = "result_imu.csv";
std::string RESULT_PATH_IMU_DETAIL = "result_imu_detail.csv";
std::string RESULT_PATH_VISUAL = "result_visual.csv";
std::string RESULT_PATH_PRIOR = "result_prior.csv";
