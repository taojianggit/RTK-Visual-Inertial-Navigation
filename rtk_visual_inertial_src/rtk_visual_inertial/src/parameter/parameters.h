...
//paths for saving detailed residual results
extern std::string RESULT_PATH_TOTAL;
extern std::string RESULT_PATH_GNSS;
extern std::string RESULT_PATH_IMU;
extern std::string RESULT_PATH_IMU_DETAIL;
extern std::string RESULT_PATH_VISUAL;
extern std::string RESULT_PATH_PRIOR;
//imu ros topic
