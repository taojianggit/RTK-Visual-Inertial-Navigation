...
Eigen::Vector2d projection_factor::last_raw_residual;
...
bool projection_factor::Evaluate(double const* const* parameters, double* residuals, double** jacobians) const {
    ...
    last_raw_residual = residual; // 保存原始残差
...
Eigen::Vector2d ProjectionTwoFrameTwoCamFactor::last_raw_residual;
...
Eigen::Vector2d ProjectionTwoFrameOneCamFactor::last_raw_residual;
...
Eigen::Vector2d ProjectionOneFrameTwoCamFactor::last_raw_residual;
